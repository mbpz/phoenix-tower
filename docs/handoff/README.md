...
- [evidence](yellow-crane/evidence/)：v08 历史证据、v09 纯几何预检，以及v10/v12/v13的拓扑、
...
2. 本机13已完成本轮有界几何复验及三机位视觉检查，仍须改形；不要重建或覆盖。后续改形使用新版本 **14**（若存在则递增），保留08/09/10/研究11/12/13。
